...
#    plt.ioff()
    ...
    for i in range(len(pTs)-1): 
        ...
        q_pred = test(X_test, model_from='combined_models/{}'.format(target), scale_par=target_scale_par)
        ...
        fig.savefig('plots/combined_' + target + '_' + str(i) + '.png')
#        fig.savefig('plots/combined_' + target + '_' + str(i) + '.pdf')
        plt.close(fig)
