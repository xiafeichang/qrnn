...
def train(X, Y, qs, qweights=None, num_hidden_layers=3, num_units=None, act=None, num_connected_layers=1, sample_weight=None, l2lam=1.e-3, opt='SGD', lr=0.1, dp_on=False, dp=None, gauss_std=None, batch_size=64, epochs=10, checkpoint_dir='./ckpt', save_file=None, evaluate_data=None, model_plot=None):
